...
if(isset($_POST["submit"])){
  ...
  $duplicate = mysqli_query($conn, "SELECT * FROM registration_tab WHERE username = '$username' OR email = '$email'");
  if(mysqli_num_rows($duplicate) > 0){
    ...
    if($password == $confirmpassword){
      $query = "INSERT INTO registration_tab (firstname,lastname,email,username,Password)
          ...
          <div class="col-12 col-lg-9 col-xl-7">
           ...
           <form class="fw-bold" action="" method="post">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <p>
  		Already a member? <a href="nalogin.php">Sign in</a>
  	</p>
                </form>
              </div>
            </div>
