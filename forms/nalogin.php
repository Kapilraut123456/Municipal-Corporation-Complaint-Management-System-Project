...
if(isset($_POST["login"])){
  ...
  $result = mysqli_query($conn, "SELECT * FROM registration_tab WHERE username = '$usernameemail' OR email = '$usernameemail'");
    ...
    <div class="login p-5">
      <div class="login1">
        ...
        <form class="p-3" action="" method="post">
          ...
          <p>
  		Already a member? <a href="registration.php">Go To Registration</a>
  	</p>
